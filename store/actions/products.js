...
export const fetchProducts=()=>{
    return async (dispatch,getState)=>{
        ...
        try{
        const response=await fetch(`https://rn-first-fe6f9-default-rtdb.firebaseio.com/products.json?auth=${token}`)
...
export const deleteProduct=productId=>{
    return async (dispatch,getState)=>{
        const token=getState().auth.token
     const response= await fetch(`https://rn-first-fe6f9-default-rtdb.firebaseio.com/products/${productId}.json?auth=${token}`,{
            method:'DELETE',
...
export const updateProduct=(id,title,description,imageUrl)=>{
    ...
    return async (dispatch,getState)=>{
        const token=getState().auth.token
  const response = await fetch(`https://rn-first-fe6f9-default-rtdb.firebaseio.com/products/${id}.json?auth=${token}`,{
           method:'PATCH',
           headers:{
               'Content-Type':'application/json'
           } ,
